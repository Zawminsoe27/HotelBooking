    ...
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-25 md:pt-30 px-4 lg:px-24 xl:px-32">
      <div>
        ...
        {roomsDummyData.map((room) => (
          <div
            key={room._id}
            className="flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-700/30 last:pb-30 last:border-0"
          >
            <img
              onClick={() => {
            ...
            <div className="md:w-1/2 flex flex-col gap-2">
              ...
              {/* {Room Amenitied} */}
              <div className="flex flex-wrap items-center mt-3 mb-6 gap-5">
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 mx-lg:mb-8 min-lg:mt-16">
        ...
        >
          ...
          <div>
            <span className="block lg:hidden cursor-pointer" onClick={() => setOpenFilters(!openFilters)}>
